...
<head>
  ...
  <link rel="stylesheet" href="{{asset('template/pluginplugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">ALMUS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin Almus</a>
        </div>
      </div>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('template/pplugins/jquery-ui/jquery-ui.min.js')}}"></script>
